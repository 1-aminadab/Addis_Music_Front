  ...
  return (
    <Navbar>
      ...
      <CustomButton
        ...
        padding="5px 10px"
        width="fit-content"
        customStyles={`align-items:center; position:relative; background: linear-gradient(135deg, ${theme.colors.secondaryBackground}, ${ theme.colors.primary + '55'}); justify-content:center`}
